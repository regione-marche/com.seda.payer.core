 ...
 *
 */
public class InputTextTag extends HTMLInputTextSupport {

	private static final long serialVersionUID = 1L;
	
	private static final LoggerWrapper logger =  CustomLoggerManager.get(InputTextTag.class);
    ...
    public int doEndTag() throws JspTagException {
    	...
    	try {
    		...
    		html.append(getMask() != null ? (" mask=\"" + getMask() + "\"") : "");
