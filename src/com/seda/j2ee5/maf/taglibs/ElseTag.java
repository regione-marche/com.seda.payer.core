...
public class ElseTag extends BodyTagSupport {
	...
	private static final LoggerWrapper logger =  CustomLoggerManager.get(ElseTag.class);
	
	private String elseHTML;
	...
	public int doEndTag() throws JspTagException {
		...
		try {
			if (ifTag!=null && !ifTag.getTest()) {
				pageContext.getOut().print(elseHTML.toString());				
			}			
			return EVAL_PAGE;
		}
		catch (IOException e) {
