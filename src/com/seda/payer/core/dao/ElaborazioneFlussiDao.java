...
public class ElaborazioneFlussiDao extends BaseDaoHandler {
	...
	//fine LP 20240920 - PGNTECCSV-10
		...
		try {
			...
			callableStatement.setBigDecimal(10, new BigDecimal(tributo));			
			//callableStatement.setDouble(11, tribPagato);
			callableStatement.setBigDecimal(11, new BigDecimal(tribPagato));			
			...
			callableStatement.setBigDecimal(15, new BigDecimal(importoBoll));			
			callableStatement.setBigDecimal(16, new BigDecimal(mora));			
			callableStatement.setBigDecimal(17, new BigDecimal(aggioDovuto));			
			callableStatement.setBigDecimal(18, new BigDecimal(aggioOriginario));			
			callableStatement.setBigDecimal(19, new BigDecimal(aggioScadenza));			
			callableStatement.setBigDecimal(20, new BigDecimal(aggioPagato));			
			callableStatement.setBigDecimal(21, new BigDecimal(notifica));			
			callableStatement.setBigDecimal(22, new BigDecimal(notificaPagata));			
	...
	//fine LP 20240920 - PGNTECCSV-10
	{
		...
		try {
			...
			callableStatement.setBigDecimal(12, new BigDecimal(importo));
	...
	//fine LP 20240920 - PGNTECCSV-10
		...
		try {
			...
			callableStatement.setBigDecimal(14, new BigDecimal(importo));
			if(capitolo != null)
	...
	//fine LP 20240828 - PGNTACWS-22
		...
		try {
			...
			callableStatement.setBigDecimal(15, new BigDecimal(importoPagato));
			//callableStatement.setDouble(16, notifica);
			callableStatement.setBigDecimal(16, new BigDecimal(notifica));
			//callableStatement.setDouble(17, aggioCoattivo);
			callableStatement.setBigDecimal(15, new BigDecimal(aggioCoattivo));
			//callableStatement.setDouble(18, spese);
			callableStatement.setBigDecimal(15, new BigDecimal(spese));
			//callableStatement.setDouble(19, mora);
			callableStatement.setBigDecimal(19, new BigDecimal(mora));
	...
	//fine LP 20240920 - PGNTECCSV-10
		...
		try {
			...
			callableStatement.setBigDecimal(10, new BigDecimal(speseDovute));
			//callableStatement.setDouble(11, spesePagate);
			callableStatement.setBigDecimal(11, new BigDecimal(spesePagate));
			//callableStatement.setDouble(12, mora);
			callableStatement.setBigDecimal(12, new BigDecimal(mora));
