...
public class AnagraficaStrutturaRicettiva extends Lifecycle implements Serializable{
	...
	public String toString() {
		return "AnagraficaStrutturaRicettiva{" +
				"chiaveStrutturaRicettiva='" + chiaveStrutturaRicettiva + '\'' +
				", codiceBelfiore='" + codiceBelfiore + '\'' +
				", codiceAutorizzazione='" + codiceAutorizzazione + '\'' +
				", partitaIVAStruttura='" + partitaIVAStruttura + '\'' +
				", ragioneSocialeStruttura='" + ragioneSocialeStruttura + '\'' +
				", insegnaStruttura='" + insegnaStruttura + '\'' +
				", anagraficaTitolare='" + anagraficaTitolare + '\'' +
				", codFiscaleTitolare='" + codFiscaleTitolare + '\'' +
				...
				", codiceEnteGestionaleEntrate='" + codiceEnteGestionaleEntrate + '\'' +
				", impostaServizioGestionaleEntrate='" + impostaServizioGestionaleEntrate + '\'' +
				", codiceContribuenteGestionaleEntrate='" + codiceContribuenteGestionaleEntrate + '\'' +
				", dataUltimoAggiornamento=" + dataUltimoAggiornamento +
				", operatoreUltimoAggiornamento='" + operatoreUltimoAggiornamento + '\'' +
				", emailPec='" + emailPec + '\'' +
				", flagSubentro='" + flagSubentro + '\'' +
				", dataValiditaInizio=" + dataValiditaInizio +
				", dataValiditaFine=" + dataValiditaFine +
				", dataObbligoComunicazioneInizio=" + dataObbligoComunicazioneInizio +
				", dataObbligoComunicazioneFine=" + dataObbligoComunicazioneFine +
				", note='" + note + '\'' +
				", codiceAutorizzazionePrincipale='" + codiceAutorizzazionePrincipale + '\'' +
				", telefono='" + telefono + '\'' +
				", dataNascitaTitolare=" + dataNascitaTitolare +
				", provinciaTitolare='" + provinciaTitolare + '\'' +
				", comuneTitolare='" + comuneTitolare + '\'' +
				", dataNascitaGestore=" + dataNascitaGestore +
				", provinciaGestore='" + provinciaGestore + '\'' +
				", comuneGestore='" + comuneGestore + '\'' +
				", codFiscaleGestore='" + codFiscaleGestore + '\'' +
				", anagraficaGestore='" + anagraficaGestore + '\'' +
				", pinCodeMail='" + pinCodeMail + '\'' +
				", pinCodeMailPec='" + pinCodeMailPec + '\'' +
				", flagPinCodeMail='" + flagPinCodeMail + '\'' +
				", flagPinCodeMailPec='" + flagPinCodeMailPec + '\'' +
				", flagPrincipale='" + flagPrincipale + '\'' +
				", comuneCatastale='" + comuneCatastale + '\'' +
				", particellaEdificiale='" + particellaEdificiale + '\'' +
				", subalterno='" + subalterno + '\'' +
				", superficie=" + superficie +
				", postiLetto=" + postiLetto +
				", piano='" + piano + '\'' +
				", numAlloggiTotali=" + numAlloggiTotali +
				", numAlloggiAttivi=" + numAlloggiAttivi +
