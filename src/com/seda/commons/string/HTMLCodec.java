...
/**
 * Gives the support to encoding a character in a string to the corresponding html entity name
 * @author Seda Lab
 *
 */
public class HTMLCodec {
	...
	public final static String encodeHtml(String buffer) {
		...
		for(int i=0, j=buffer.length(); i<j; i++) {
			...
			case '\'': filtered.append("&apos;"); break; /*(does not work in IE) apostrophe*/  
...
//			case ' ': filtered.append("&nbsp;"); break; /*non-breaking space*/ 
			...
			case '«': filtered.append("&laquo;"); break; /*angle quotation mark (left)*/ 
			...
			case '»': filtered.append("&raquo;"); break; /*angle quotation mark (right)*/ 
			...
			case 'Â': filtered.append("Acirc;"); break; /*capital a, circumflex accent*/ 
			...
			case 'Ê': filtered.append("&Ecirc;"); break; /*capital e, circumflex accent*/ 
			...
			case 'Î': filtered.append("&Icirc;"); break; /*capital i, circumflex accent*/ 
			...
			case 'Ô': filtered.append("&Ocirc;"); break; /*capital o, circumflex accent*/ 
			...
			case 'Û': filtered.append("&Ucirc;"); break; /*capital u, circumflex accent*/ 
